defmodule MitbitsCryptocurrencyWeb.Utility do
  def add_txn(txn) do
    [{_, unchained_txn}] = :ets.lookup(:MitbitsCryptocurrencyWeb, "unchained_txn")
    updated_unchained_txns = unchained_txn ++ [txn]
    # IO.inspect Enum.count updated_unchained_txns
    :ets.insert(:MitbitsCryptocurrencyWeb, {"unchained_txn", updated_unchained_txns})
    {:ok}
  end
